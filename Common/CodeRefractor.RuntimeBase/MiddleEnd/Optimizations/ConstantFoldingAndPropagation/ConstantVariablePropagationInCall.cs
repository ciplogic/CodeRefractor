    ...
    public class ConstantVariablePropagationInCall : ConstantVariablePropagationBase
    {
        public override void OptimizeOperations(CilMethodInterpreter interpreter)
        {
            ...
            for (var i = 0; i < operations.Length - 1; i++)
            {
                ...
                if (constValue == null)
                    continue;
                PropagateConstantForward(operations, i, constValue, srcVariableDefinition);
            }
        }

        private void PropagateConstantForward(LocalOperation[] operations, int indexOp, ConstValue constValue,
